...
const AuthProvider = ( {children}) => {
    ...
    const handleRegister = (form) => {
        ...
        fetch('http://15.223.3.11:8080/users/register', {  
            method: 'POST', 
            mode: 'cors', 
    ...
    const handleLogin = (form) => {
        ...
        fetch('http://15.223.3.11:8080/users/login', {  
            method: 'POST', 
            mode: 'cors', 
            body: JSON.stringify(form),
            headers: {'Content-Type': 'application/json'}
    ...
    const handleLogout = () => {
        fetch('http://15.223.3.11:8080/users/logout', {
            method: 'POST', 
            mode: 'cors', 
            body: '',
    ...
    const handleAllLogout = () => {
        fetch('http://15.223.3.11:8080/users/logoutAll', {
            method: 'POST', 
            mode: 'cors', 
            body: '',
            headers: { "Authorization": "Bearer "+ token}
